    ...
    :UIScreen(game, fontName, isClosable)
{
    ...
    mButtonPos = Vector2(321, 426);
    mButtonPos2 = Vector2(1013, 426);
    mButtonTextOffset = Vector2(10, 0);
    mTextPos = Vector2(835, 454);
    mTextPos2 = Vector2(1527, 454);
    ...
    [this]() {
        ...
        mGame->RebindKeyboard(GetTexts()[6], Game::Action::Dash);
    }
    , false, mButtonTextOffset);
    button->UseBackGroundColor();
    ...
    [this]() {
        ...
        mGame->RebindKeyboard(GetTexts()[7], Game::Action::Dash);
    }
    , false, mButtonTextOffset);
    button->UseBackGroundColor();
