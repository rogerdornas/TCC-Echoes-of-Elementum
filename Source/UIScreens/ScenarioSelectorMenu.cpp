    ...
    :UIScreen(game, fontName, isClosable)
{
    ...
    background = AddImage("../Assets/Sprites/Menus/FundoPretoArredondado.png", Vector2(960, 650), Vector2(1300, 800));
    background->SetAlpha(0.4f);

    AddText("SELEÇÃO DE CENÁRIO", Vector2(960, 330), 40, Vector3(1.0f, 1.0f, 1.0f));

    Vector2 buttonSize(445, 50);
    Vector2 buttonPos(765, 380);
    float distanceBetweenButtons = 60.0f;
    ...
    AddButton("GOLEM DE CRISTAL", buttonPos + Vector2(0, 1 * distanceBetweenButtons),
                 buttonSize, 34, UIButton::TextPos::AlignLeft,
    [this]() {
    ...
    AddButton("GOLEM DE FOGO", buttonPos + Vector2(0, 2 * distanceBetweenButtons),
             buttonSize, 34, UIButton::TextPos::AlignLeft,
    [this]() {
    ...
    AddButton("RAPOSA GUERREIRA", buttonPos + Vector2(0, 3 * distanceBetweenButtons),
            buttonSize, 34, UIButton::TextPos::AlignLeft,
    [this]() {
