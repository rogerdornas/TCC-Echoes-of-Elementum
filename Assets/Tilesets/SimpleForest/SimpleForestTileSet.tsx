...
<tileset version="1.10" tiledversion="1.11.2" name="SimpleForestTileSet" tilewidth="32" tileheight="32" spacing="2" margin="1" tilecount="45" columns="5">
 <image source="SimpleForestTileSet.png" width="170" height="306"/>
 <wangsets>
